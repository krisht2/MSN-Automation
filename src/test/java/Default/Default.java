...
public class Default {
    ...
    String url = "http://pubsolmsn:pubsolmsn%40123@staging-ms.origin-website.net/ignore-test/did-you-know-these-50-weird-facts-about-all-50-states?utm_source=msn&lcid=90223099";
    String slideshowURL="http://pubsolmsn:pubsolmsn%40123@staging-ms.origin-website.net/ignore-test/did-you-know-these-50-weird-facts-about-all-50-states-slideshow?utm_source=msn&lcid=90223099";
    ...
    public void setUp() {
        ...
        String extentReportFile = System.getProperty("user.dir") + "\\MSNDefault.html";
...
//                logger.log(LogStatus.INFO,"Media Credit = " + driver.findElement(By.className("media-credit")).getText());
               ...
               // Thread.sleep(1000);
            try {
                defaultPage.clickContinueDefault();
            }catch (Exception e){
                System.out.println("******************************\n\nException caught!! \n\n***************************");
